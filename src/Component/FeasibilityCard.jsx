...
const FeasibilityCard = () => {
  ...
  const feasibilityMap = {
    High: { 
      ...
      textColor: 'text-feasibility-high',
    ...
    Medium: { 
      ...
      textColor: 'text-feasibility-medium',
    ...
    Low: { 
      ...
      textColor: 'text-feasibility-low',
  ...
  return (
    <DashboardCard title="Feasibility Check">
      ...
      <div className={`flex items-center justify-center text-center text-sm mt-4 p-2 rounded-lg ${currentStatus.textColor} bg-opacity-10 bg-${currentStatus.textColor.replace('text-', '')}`}>
        <currentStatus.Icon className={`w-5 h-5 mr-2 shrink-0 ${currentStatus.textColor}`} />
